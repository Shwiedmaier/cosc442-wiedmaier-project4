...
public class Main {
    ...
    public static void mainMenu() {
        ...
        System.out.println("0. Exit" + System.lineSeparator());
    ...
    public static void deleteRecipe() {
        ...
        if(recipeDeleted) System.out.println("successfully deleted.");
    ...
    public static String inputOutput(String message) {
        ...
        final Logger log = Logger.getLogger("edu.towson.cis.cosc442.project4.coffeemaker");
